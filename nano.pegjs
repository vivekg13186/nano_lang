...
Expression = _ "(" opCode:OpCode args:Argument* ")" _ { return {type :"exp", opCode ,args }}
Comment =   _ "#" (!LineTerminator SourceCharacter)* _
OpCode  = _ opcode:Identifier _   { return opcode; }
         / _ "+" _ { return "+" ;}
         / _ "-" _ { return "-" ;}
         / _ "*" _ { return "*" ;}
         / _ "/" _ { return "/" ;}
...
Argument = _ v:String _ { return v; }
         / _ v:False _ { return v; }
         / _ v:True _ { return v; }
         / _ v:Identifier _ { return v; }
         / _ v:Number _ { return v; }
         / _  v:Null _ { return v; }
...
Number "number"
  = minus? int frac? exp? {  return {type : "number" , value : parseFloat(text()) };   }
...
// ----- 7. Strings -----
Identifier
  =   name:IdentifierName { return {type : "iden" , value : name }  }
